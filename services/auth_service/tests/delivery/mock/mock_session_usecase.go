...
// Source: services/auth_service/internal/usecase/session.go
//
// Generated by this command:
//
//	mockgen -source=services/auth_service/internal/usecase/session.go -destination=services/auth_service/tests/mock_session_usecase.go -package=mocks
//
