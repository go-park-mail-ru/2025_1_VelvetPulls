...
func (m *MockIChatUsecase) LeaveChat(ctx context.Context, userID, chatID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LeaveChat", ctx, userID, chatID)
	ret0, _ := ret[0].(error)
	return ret0
}

// LeaveChat indicates an expected call of LeaveChat.
func (mr *MockIChatUsecaseMockRecorder) LeaveChat(ctx, userID, chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LeaveChat", reflect.TypeOf((*MockIChatUsecase)(nil).LeaveChat), ctx, userID, chatID)
}
