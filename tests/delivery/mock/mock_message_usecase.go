...
func (m *MockIMessageUsecase) SendMessage(ctx context.Context, messageInput *model.MessageInput, userID, chatID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMessage", ctx, messageInput, userID, chatID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendMessage indicates an expected call of SendMessage.
func (mr *MockIMessageUsecaseMockRecorder) SendMessage(ctx, messageInput, userID, chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockIMessageUsecase)(nil).SendMessage), ctx, messageInput, userID, chatID)
}
