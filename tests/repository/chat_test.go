...
func TestGetChatByID(t *testing.T) {
	// Создаём sql.DB с помощью sqlmock.
	...
	// Подготавливаем sqlmock.Rows с ожидаемыми полями.
...
func TestGetChats(t *testing.T) {
	...
	// lastChatID должен быть равен ID последнего чата
